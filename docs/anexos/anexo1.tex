...
A tabela seguinte apresenta a relação completa entre os objetos
implementados no nível ``Casa'', a respetiva categoria e os minerais
associados, conforme definido na estrutura de dados do jogo. Esta
informação serve de base para a geração dos questionários.

\begin{longtable}{p{0.25\textwidth} p{0.15\textwidth} p{0.55\textwidth}}
  \caption{Lista de objetos interativos e minerais constituintes.}
  \label{tab:anexo_objetos} \\
  \hline
