...
Atualmente, o jogo também requer que as imagens do cenário (chão, paredes) sejam colocadas na pasta de imagens (\texttt{web/source/layers/layers\_mapa3}). Estas imagens devem ser desenhadas por um artista para corresponderem ao mapa de texto criado.
