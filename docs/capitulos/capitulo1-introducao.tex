...
O código fonte do projeto encontra-se disponível na plataforma GitHub em \url{https://github.com/torres-engineer/minerals-house}, e a versão jogável pode ser acedida através do GitHub Pages em \url{https://torres-engineer.github.io/minerals-house/}.
...
de forma expositiva, o utilizador explora cenários familiares começa numa casa, depois vamos para uma escola, etc., etc. e descobre por si próprio quais os minerais presentes nos objetos à sua
