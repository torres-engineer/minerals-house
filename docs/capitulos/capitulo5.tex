...
De forma geral, o projeto pode crescer para incluir mais cenários, 
mais minerais e melhor acessibilidade. O próximo 
passo é avançar com a implementação prática das funcionalidades que faltam.
...
exploração da casa, a equipa já identificou várias expansões futuras
que poderiam melhorar o jogo em termos pedagógicos e de acessibilidade.
